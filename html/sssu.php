      ...
      <form class="d-flex" role="search">
        ...
        <div class="" id="navbarSupportedContent ">
          <ul class="navbar-nav me-auto mb-2 ">
              <li class="nav-item fontt-text">
                <a class="nav-link active hover" aria-current="page" href="menu.php"> Menu </a>
              </li>
              <li class="nav-item fontt-text">
              ...
              <a href="carritoo.php" class="list-group-item list-group-item-action  fontt-text ">
        ...
        <div class="listaus dropdown" >
                    <button class="btnusuario border-0 rounded-circle dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="dropdown">
                        <img class='usuario'  src="../img/usuario/capi.png" alt="Usuario" width="50px">
                    </button>    
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown">
                        <img class='usuario'  src="../img/usuario/capi.png" alt="Usuario" width="50px">
                        <a class="dropdown-item text-white fontt-text" href="cuenta.php"> Mi cuenta</a>
                        <a class="dropdown-item text-white fontt-text" href="carritoo.php"> Carrito </a>
                        <a class="dropdown-item text-white fontt-text" href="pedidos.php"> Pedidos </a>           
                        <a class="dropdown-item text-white fontt-text" href="listadeseos.php"> Lista de deseos </a>
                        <a class="dropdown-item text-white fontt-text" href="configuracion.php"> Configuración </a>
                        <a class="dropdown-item text-white fontt-text" data-bs-toggle="modal" data-bs-target="#exampleModal"> Cerrar sesion </a>               
                    </div>
        </div>
    </div>
</nav>
